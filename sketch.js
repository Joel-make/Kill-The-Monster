...
var hero,monster,rope,ground,theme;
var gameState=0;
var PLAY=0;
var END=1;
var visibility=0;
...
function draw() {
  ...
  if(gameState===0)
  {
    ...
    visibility+=5;
    tint(255,visibility);
    image(logo,350,300,700,200);
    image(logo2,343,495,740,110);
    textFont("Times New Roman")
    textSize(25)
    stroke("black")
    fill("black")
    text("Note:Decrease you system's volume and press space key",10,35);
